...
function createNote() {
  let notes = localStorage.getItem("notes");
    let noteHeading = "Título da sua anotação";
  let noteText = "Sua anotação";
...
${element.text}</textarea>
  ...
  if (notesObj.length != 0) {
    row.innerHTML = html;
      ...
      row.innerHTML = `<h4>Ainda sem notas! Por favor, adicione uma nota. <img src="arrow.png" width="50"/></h4>`;
  }
}
